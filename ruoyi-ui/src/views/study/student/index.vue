  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['study:student:remove']"
        >删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['study:student:export']"
        >导出
        </el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="学历" prop="educationId">
          <el-input v-model="form.educationId" placeholder="请输入学历"/>
        </el-form-item>
        <el-form-item label="专业" prop="major">
...
<script>
import {addStudent, delStudent, getStudent, listStudent, updateStudent} from "@/api/study/student";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('study/student/export', {
        ...this.queryParams
